        ...
        switch (x) {
            ...
            case 'cpf':
                if (re_cpf.test(elemento) == false) {
                    document.getElementById("id_" + x).setAttribute("style", "border-bottom-color: #eb4a46");
                    document.getElementById("msg_" + x).innerText = "CPF inv\u00e1lido. Inserir no formato: xxx.xxx.xxx-xx.";
                }
                break;

            case 'tel':
                if (re_tel.test(elemento) == false) {
                    document.getElementById("id_" + x).setAttribute("style", "border-bottom-color: #eb4a46");
                    document.getElementById("msg_" + x).innerText = "Telefone inv\u00e1lido. Inserir no formato: (xx)xxxxxxxx.";
                }
                break;
            default:
                break;
